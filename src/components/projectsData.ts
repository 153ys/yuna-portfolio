...
export const projectsData: Project[] = [
  {
    ...
    projectInfo: [
      ...
      },
      {
        title: "收穫與反思",
        content:
          "第一次完整參與前端開發，讓我開始理解元件拆分、資料流與技術限制，也讓我在設計時能同步思考方案是否容易實作，而不是只追求視覺呈現。這次專案最大的收穫，不只是完成一個社群產品，而是開始建立從需求、體驗到實作的完整思考方式。[br]未來如果有更多時間，希望能加入使用者測試與數據驗證，確認設計是否真正改善使用者體驗，而不只是依據團隊討論或設計直覺做決策。",
      },
    ],
  },
  {
    ...
    projectInfo: [
      {
        title: "技術與工具",
        tech: ["LINE LIFF", "Figma", "AI", "UI Design", "Prototype"],
      },
      {
        title: "專案背景",
        content:
      ...
      },
      {
        title: "我的角色",
        content:
          "與創意及技術成員共同發想 AI 技術運用方式、負責介面視覺設計與使用者流程規劃、製作簡易 Figma Wireframe 與 Prototype 驗證互動流程、參與 AI 籤詩呈現方式與內容結構調整",
      },
      {
        title: "設計流程",
        subTitle: "需求分析",
        content:
          "專案初期的需求是運用 AI 生成個人化籤詩，讓使用者輸入資料與問題後，能取得對應主題的求籤結果。然而在需求拆解時，我們發現如果流程只停留在「輸入問題 → 取得 AI 回答」，體驗會更接近一般 AI 問答工具，難以傳達神社求籤應有的期待感與儀式感。因此設計重點不只是讓 AI 產生內容，而是思考如何把 AI 回覆包裝成一段完整的求籤體驗。",
      },
      {
        subTitle: "Wireframe",
        content:
          "我先以快速驗證功能流程為目標，繪製初版 Wireframe，讓使用者在輸入個人資料後進入提問與結果頁。經過流程檢視後，我們發現雖然操作順暢，但使用者幾乎可以直接取得結果，缺少求籤前的情境鋪陳與參與過程。",
        image: [
          {
            image:
      ...
      },
      {
        subTitle: "流程迭代",
        content:
          "後續重新調整使用者流程，在提問與取得籤詩之前加入洗手、投幣、搖鈴等參拜儀式，並搭配主題選擇與角色引導，讓使用者先進入神社情境，再逐步完成求籤。這樣 AI 籤詩就不只是即時回答，而是整段互動體驗的最後回饋。",
        image: [
          {
            image:
      ...
      },
      {
        title: "收穫與反思",
        content:
          "這次專案讓我重新思考 AI 在產品中的角色。真正的體驗設計並不是把生成內容放進介面，而是從使用者進入流程開始，就透過情境、互動與資訊設計建立合理的期待，讓 AI 回覆成為整體體驗的一部分。也因為參與了 AI 籤詩內容規劃與結果頁設計，我更理解生成內容需要與 UI 一起規劃，才能兼顧閱讀體驗與資訊一致性。[br]由於此專案主要作為提案展示使用，尚未進入正式上線階段，因此未取得實際使用數據。未來如果有機會進一步發展，我希望能透過使用者測試與正式上線，驗證各流程節點的完成率、停留時間及中途離開率，並根據數據持續優化整體體驗。",
      },
    ],
  },
